...
def run_mrp(gamma, lambdaPar, targetEpsilon):
	# helper function that runs the trial with parameters

	toyMRP.runToy(gamma, lambdaPar, targetEpsilon, num_trials, expSeed, 
...
# parallelize running the mrp
Parallel(n_jobs = num_cores)(delayed(run_mrp)(gamma, lamb, eps) \
